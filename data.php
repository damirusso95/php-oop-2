...
$prodotti = [
    new Cibo(1, "Crocchette per cani", "Deliziose crocchette per il tuo cane", 29.99, $cani, "2024-12-31", ["carne", "riso"]),
    new Gioco(2, "Palla per gatti", "Una palla colorata per il tuo gatto", 9.99, $gatti, "plastica", "10cm"),
    new Cuccia(3, "Cuccia per cani", "Una comoda cuccia per il tuo cane", 49.99, $cani, "80x60x60cm", "legno")
];
